...
SAFE_TASK_METADATA: Dict[str, Dict[str, Any]] = {
    "documentation_update": {
        ...
        "allowed_directories": ["docs/", "README.md", "CONTRIBUTING.md", "CHANGELOG.md", "LICENSE"],
    ...
    "fix_typo": {
        ...
        "allowed_directories": ["src/", "lib/", "docs/", "tests/", "components/", "README.md"],
        "requires_review": False,
        "requires_tests": False,
    ...
    "env_sync": {
        ...
        "allowed_directories": [".env.example", "config/env.schema.yaml", "env.schema.yaml"],
        "requires_review": True,
        "requires_tests": False,
    ...
    "config_update": {
        ...
        "allowed_directories": ["config/", "package.json", "pyproject.toml", "tsconfig.json", ".github/"],
        "requires_review": True,
        "requires_tests": False,
