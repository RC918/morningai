...
app.register_blueprint(phase4_bp, url_prefix=\"/api/phase4\")
app.register_blueprint(phase5_bp, url_prefix=\"/api/phase5\")
app.register_blueprint(phase6_bp, url_prefix=\"/api/phase6\")
...
# --- SPA catch-all moved below API blueprints ---
@app.route('/<path:path>')
def serve(path):
