...
export const PaddingExamples: Story = {
  render: () => (
    <div className="space-y-6 p-8 bg-neutral-50 dark:bg-neutral-900 rounded-xl">
      <div className="bg-white dark:bg-neutral-800 p-2 rounded-lg shadow-md">
    ...
    <div className="space-y-8 p-8 bg-neutral-50 dark:bg-neutral-900 rounded-xl">
      <div>
        ...
        <div className="flex gap-2">
          <div className="w-20 h-20 bg-primary-500 rounded-lg" />
          <div className="w-20 h-20 bg-primary-500 rounded-lg" />
          <div className="w-20 h-20 bg-primary-500 rounded-lg" />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex gap-4">
          <div className="w-20 h-20 bg-success-500 rounded-lg" />
          <div className="w-20 h-20 bg-success-500 rounded-lg" />
          <div className="w-20 h-20 bg-success-500 rounded-lg" />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex gap-6">
          <div className="w-20 h-20 bg-accent-500 rounded-lg" />
          <div className="w-20 h-20 bg-accent-500 rounded-lg" />
          <div className="w-20 h-20 bg-accent-500 rounded-lg" />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex gap-8">
          <div className="w-20 h-20 bg-error-500 rounded-lg" />
          <div className="w-20 h-20 bg-error-500 rounded-lg" />
          <div className="w-20 h-20 bg-error-500 rounded-lg" />
        </div>
      </div>
    ...
    <div className="space-y-8 p-8 bg-neutral-50 dark:bg-neutral-900 rounded-xl">
      <div>
        ...
        <div className="space-y-2">
          <div className="bg-primary-500 text-white p-3 rounded-lg">項目 1</div>
          <div className="bg-primary-500 text-white p-3 rounded-lg">項目 2</div>
          <div className="bg-primary-500 text-white p-3 rounded-lg">項目 3</div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="bg-success-500 text-white p-3 rounded-lg">項目 1</div>
          <div className="bg-success-500 text-white p-3 rounded-lg">項目 2</div>
          <div className="bg-success-500 text-white p-3 rounded-lg">項目 3</div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="space-y-6">
          <div className="bg-accent-500 text-white p-3 rounded-lg">項目 1</div>
          <div className="bg-accent-500 text-white p-3 rounded-lg">項目 2</div>
          <div className="bg-accent-500 text-white p-3 rounded-lg">項目 3</div>
        </div>
      </div>
    </div>
  ),
...
export const CardSystem: Story = {
  render: () => (
    <div className="grid grid-cols-3 gap-6 p-8 bg-neutral-50 dark:bg-neutral-900 rounded-xl">
      {/* 緊湊卡片 */}
      <div className="bg-white dark:bg-neutral-800 p-4 rounded-lg shadow-md space-y-2">
        <h4 className="font-semibold">緊湊卡片</h4>
        <p className="text-sm text-neutral-600 dark:text-neutral-300">p-4, space-y-2</p>
        <p className="text-2xl font-bold">1,234</p>
      </div>
      
      {/* 標準卡片 */}
      <div className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-md space-y-4">
        <h4 className="font-semibold">標準卡片</h4>
        <p className="text-sm text-neutral-600 dark:text-neutral-300">p-6, space-y-4</p>
        <p className="text-2xl font-bold">5,678</p>
      </div>
      
      {/* 大型卡片 */}
      <div className="bg-white dark:bg-neutral-800 p-8 rounded-2xl shadow-md space-y-6">
        <h4 className="font-semibold">大型卡片</h4>
        <p className="text-sm text-neutral-600 dark:text-neutral-300">p-8, space-y-6</p>
...
export const FormSystem: Story = {
  render: () => (
    <div className="max-w-md mx-auto p-8 bg-neutral-50 dark:bg-neutral-900 rounded-xl">
      <form className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-lg space-y-6">
        ...
        <div className="flex gap-4 pt-4">
          <button className="flex-1 bg-primary-600 text-white px-6 py-3 rounded-lg hover:bg-primary-700 transition-colors">
            提交
          </button>
          <button className="flex-1 bg-neutral-200 dark:bg-neutral-700 px-6 py-3 rounded-lg hover:bg-neutral-300 dark:hover:bg-neutral-600 transition-colors">
            取消
          </button>
        </div>
      </form>
...
export const Navbar: Story = {
  render: () => (
    <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl overflow-hidden">
      <nav className="bg-white dark:bg-neutral-800 shadow-md px-6 py-4">
    ...
    <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl overflow-hidden">
      ...
      <main className="py-8 px-6">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          <div className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-md">
            <h3 className="text-sm font-semibold text-neutral-600 dark:text-neutral-400 mb-2">總用戶</h3>
            <p className="text-3xl font-bold">1,234</p>
            <p className="text-xs text-success-600 mt-1">+5.2%</p>
          </div>
          <div className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-md">
            <h3 className="text-sm font-semibold text-neutral-600 dark:text-neutral-400 mb-2">活躍用戶</h3>
            <p className="text-3xl font-bold">856</p>
            <p className="text-xs text-success-600 mt-1">+12.8%</p>
          </div>
          <div className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-md">
            <h3 className="text-sm font-semibold text-neutral-600 dark:text-neutral-400 mb-2">轉換率</h3>
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-8">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex items-center gap-4 p-4 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-700 cursor-pointer">
...
export const VisualHierarchy: Story = {
  render: () => (
    <div className="max-w-2xl mx-auto p-8 bg-neutral-50 dark:bg-neutral-900 rounded-xl">
      <div className="bg-white dark:bg-neutral-800 p-8 rounded-xl shadow-lg">
        <h1 className="text-3xl font-bold mb-2">主標題</h1>
        <p className="text-neutral-500 mb-8">副標題 - 與主標題緊密相關 (mb-2)</p>
        ...
        <div className="space-y-6">
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-neutral-500">緊密相關的內容使用 space-y-2</p>
            </div>
          </section>
...
export const ResponsiveSpacing: Story = {
  render: () => (
    <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl overflow-hidden">
      <div className="p-4 md:p-6 lg:p-8 bg-white dark:bg-neutral-800">
  ...
  render: () => (
    <div className="space-y-8 p-8 bg-neutral-50 dark:bg-neutral-900 rounded-xl">
      ...
      <div>
        ...
        <div className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-md relative">
          <div className="absolute -top-3 left-4 bg-primary-600 text-white px-3 py-1 rounded-full text-sm font-semibold">
            新功能
          </div>
      ...
      <div className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-lg">
        <div className="grid grid-cols-8 gap-1">
          {Array.from({ length: 96 }, (_, i) => (
            <div 
              key={i}
              className="aspect-square bg-primary-100 dark:bg-primary-900 border border-primary-300 dark:border-primary-700"
