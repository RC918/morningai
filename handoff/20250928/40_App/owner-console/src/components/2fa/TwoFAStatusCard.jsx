  ...
  if (status?.feature_disabled) {
    return (
      <SettingsCard
        ...
        variant="default"
      >
        <div className="flex items-start p-4 bg-[var(--calm-10,#f0f9ff)] rounded-lg border border-[var(--calm,#0ea5e9)]">
          <AlertCircle className="w-5 h-5 text-[var(--calm,#0ea5e9)] flex-shrink-0 mr-3" />
          <div className="space-y-1">
            <p className="font-medium text-[var(--calm,#0ea5e9)]">
              {t('settings.2fa.featureDisabled.title')}
            </p>
            <p className="text-sm text-[var(--calm,#0ea5e9)]">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              {isEnabled ? (
                <Badge variant="default" className="bg-[var(--success-500)] flex items-center gap-1">
