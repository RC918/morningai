      ...
      <DialogContent>
        ...
        {!newCodes ? (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="p-3 bg-warning-50 dark:bg-warning-900/20 rounded-lg flex items-start gap-2">
              <AlertCircle className="w-4 h-4 text-warning-600 dark:text-warning-500" />
