    ...
    <div className="p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-title-1 font-bold">{stats.totalTenants}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-title-1 font-bold">{stats.activeAgents}</div>
            <p className="text-caption-2 text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-title-1 font-bold">${stats.totalCost.toFixed(2)}</div>
            <p className="text-caption-2 text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-title-1 font-bold">{stats.systemHealth}%</div>
