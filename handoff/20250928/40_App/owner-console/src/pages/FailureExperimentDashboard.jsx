      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="material-card hover-lift">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-callout font-medium">
          ...
          <CardContent>
            <div className="text-title-2 md:text-title-1 font-bold text-error">
        ...
        <Card className="material-card hover-lift">
          ...
          <CardContent>
            <div className="text-title-2 md:text-title-1 font-bold text-growth">
              {evalMetrics?.success_rate ? formatPercentage(evalMetrics.success_rate) : '95.2%'}
            </div>
            <p className="text-footnote text-growth flex items-center gap-1">
        ...
        <Card className="material-card hover-lift">
          ...
          <CardContent>
            <div className="text-title-2 md:text-title-1 font-bold text-wisdom">
        ...
        <Card className="material-card hover-lift">
          ...
          <CardContent>
            <div className="text-title-2 md:text-title-1 font-bold text-calm">
          ...
          <CardContent>
            {failureSummary?.by_error_type ? (
                  ...
                  return (
                    <div key={type} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-callout font-medium">{count}</span>
                      </div>
              ...
              <div className="py-12 text-center">
                <PieChart className="w-12 h-12 text-neutral-400 mx-auto mb-4" />
          ...
          {experimentComparison?.comparisons?.length > 0 ? (
            <div className="space-y-6">
              {experimentComparison.comparisons.map((exp) => (
                <div key={exp.experiment_name} className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <h3 className="font-medium text-callout">{exp.experiment_name}</h3>
                      <Badge variant={exp.active ? 'default' : 'secondary'}>
                        {exp.active ? t('common.active', 'Active') : t('common.inactive', 'Inactive')}
                      </Badge>
                    </div>
                    <div className="text-caption-2 text-neutral-500">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-caption-1">
                        <div>
                          <p className="text-neutral-500">{t('failureExperiment.charts.successRate', 'Success Rate')}</p>
            ...
            <div className="py-12 text-center">
              <Beaker className="w-12 h-12 text-neutral-400 mx-auto mb-4" />
              <p className="text-neutral-600 dark:text-neutral-400">
        ...
        <CardContent>
          {failures.length > 0 ? (
              ...
              {failures.slice(0, 5).map((failure, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-callout truncate max-w-md">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-caption-2 text-neutral-500 flex items-center gap-1">
            ...
            <div className="py-12 text-center">
              ...
              <p className="text-callout text-growth mt-2">
