...
const ALLOWED_SPACING = {
  ...
  padding: [
    ...
    'pt-0', 'pt-1', 'pt-2', 'pt-4', 'pt-5', 'pt-6', 'pt-8',
    'pb-0', 'pb-1', 'pb-2', 'pb-4', 'pb-5', 'pb-6', 'pb-8',
    'pl-0', 'pl-1', 'pl-2', 'pl-4', 'pl-5', 'pl-6', 'pl-8',
    'pr-0', 'pr-1', 'pr-2', 'pr-4', 'pr-5', 'pr-6', 'pr-8',
  ],
  // Margin utilities
  margin: [
    'm-0', 'm-1', 'm-2', 'm-4', 'm-5', 'm-6', 'm-8', 'm-auto',
    'mx-0', 'mx-1', 'mx-2', 'mx-4', 'mx-5', 'mx-6', 'mx-8', 'mx-auto',
    'my-0', 'my-1', 'my-2', 'my-4', 'my-5', 'my-6', 'my-8', 'my-auto',
    'mt-0', 'mt-1', 'mt-2', 'mt-4', 'mt-5', 'mt-6', 'mt-8', 'mt-auto',
    'mb-0', 'mb-1', 'mb-2', 'mb-4', 'mb-5', 'mb-6', 'mb-8', 'mb-auto',
    'ml-0', 'ml-1', 'ml-2', 'ml-4', 'ml-5', 'ml-6', 'ml-8', 'ml-auto',
    'mr-0', 'mr-1', 'mr-2', 'mr-4', 'mr-5', 'mr-6', 'mr-8', 'mr-auto',
...
function getSuggestion(nonStandardClass) {
  ...
  return 'Use standard spacing values (0, 1, 2, 4, 5, 6, 8)';
}
      ...
      JSXAttribute(node) {
        ...
        if (nonStandardClass) {
          ...
          context.report({
            ...
            data: {
              nonStandardClass,
              suggestion: suggestion || 'Use standard spacing values (0, 1, 2, 4, 5, 6, 8)',
            },
          });
        }
      },
