...
"""
    ...
    def _resolve_partial_paths(
        ...
        Issue #3618: When LLM extracts just a filename like 'missing_docstring.py'
        ...
        for path in extracted_paths:
            ...
            if '/' not in path:
                ...
                if len(matches) == 1:
                    ...
                    logger.debug(
                        f"[_resolve_partial_paths] Resolved '{path}' -> '{matches[0]}'"
                    )
                elif len(matches) > 1:
                ...
                # Already has directory component - keep as is
                resolved.append(path)
