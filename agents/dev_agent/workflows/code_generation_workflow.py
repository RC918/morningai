            ...
            if task_metadata and 'allowed_directories' in task_metadata:
                ...
                if allowed_dirs:
                    ...
                    for allowed in allowed_dirs:
                        ...
                        # Exact match for files like "README.md"
                        if rel_path == allowed_path:
                            is_allowed = True
                            break
                        
                        # Directory containment check for paths like "docs/"
                        # os.path.join ensures correct separator and handles trailing slashes
                        dir_prefix = os.path.join(allowed_path, '')
