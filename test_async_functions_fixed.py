...
from src.phases.phase4_meta_agent import MetaAgentDecisionHub, LangGraphWorkflowEngine, AIGovernanceConsole
from src.phases.phase5_data_intelligence import QuickSightIntegration, GrowthMarketingEngine, DataIntelligencePlatform
...
class TestSyncFunctionWrappers:
    ...
    def test_security_reviewer_sync_wrapper(self):
        ...
        from src.phases.phase6_security_governance import SecurityEvent, ThreatType, SecurityLevel
        from datetime import datetime
