...
| 指標 | 當前值 | 數據來源 | 測量日期 |
|-----|--------|---------|---------|
| 首次價值時間 (TTV) | ~15 分鐘 | 用戶訪談 | 2025-10-20 |
| 關鍵路徑成功率 | ~90% | 估計 | 2025-10-20 |
| 系統可用性 (SUS) | 未測量 | - | - |
| NPS | 未測量 | - | - |
| LCP | < 2.5s | Lighthouse | 2025-10-20 |
| CLS | < 0.1 | Lighthouse | 2025-10-20 |
| INP | < 200ms | Lighthouse | 2025-10-20 |
| WCAG 合規 | AA (部分) | 手動審查 | 2025-10-20 |
