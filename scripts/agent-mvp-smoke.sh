...
curl -fsS "$BASE/api/agent/faq" -X POST -H 'Content-Type: application/json' -d '{"question":"smoke-test"}' >/dev/null && echo "✅ FAQ endpoint responsive" || echo "⚠️  FAQ endpoint check failed"
